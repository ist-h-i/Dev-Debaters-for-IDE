...
- Also append a metrics entry (template: `metrics/README.md`) to the phase-specific `metrics/plan.md` (no dated metrics files or combined cross-phase logs), noting phase status and key risks.
