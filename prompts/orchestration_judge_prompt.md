...
- Also append a metrics entry (template: `metrics/README.md`) to the phase-specific `metrics/orchestration.md` (no dated metrics files or combined cross-phase logs), marking phase status and tests.
