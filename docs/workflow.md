...
- Metrics: append to `metrics/log.md` (or dated file) with status, tests, and artifacts; score each side on a 0-100 scale (100 = perfect).
...
5. Judges append metrics to `metrics/log.md` (or dated files) using `metrics/README.md`, scoring each side on a 0-100 scale (100 = perfect).
